...
from tuxemon.db import JSONMonsterEvolutionItem, JSONMonsterMovesetItem, db
...
class Monster:
    ...
    def __init__(self, save_data: Optional[Mapping[str, Any]] = None) -> None:
        ...
        self.moveset: List[JSONMonsterMovesetItem] = []
        self.evolutions: List[JSONMonsterEvolutionItem] = []
